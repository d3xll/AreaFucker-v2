...
local Window = Library.CreateLib("AreaFucker | Classic", "Synapse")
----PLAYERMENU
...
OtherPlayerSection:NewButton("Killers ignore", "The killers will ignore you!", function()
